...
public class DefaultSchedulerTest {
	...
	@Before
	public void setUp() {
		this.specA = new Specification(FAKE_CLOUD_NAME, FAKE_COMPUTE_IMAGE_FLAVOR_NAME,
				FAKE_FOGBOW_USER_NAME, FAKE_PUBLIC_KEY, FAKE_PRIVATE_KEY_FILE_PATH);
		this.specB = new Specification(FAKE_CLOUD_NAME+POSTFIX_B, FAKE_COMPUTE_IMAGE_FLAVOR_NAME +POSTFIX_B,
	...
	public void testAct() {
		...
		Specification specA = new Specification(FAKE_CLOUD_NAME, FAKE_COMPUTE_IMAGE_FLAVOR_NAME,FAKE_FOGBOW_USER_NAME,
