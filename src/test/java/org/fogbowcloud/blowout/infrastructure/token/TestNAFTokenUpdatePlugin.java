...
public class TestNAFTokenUpdatePlugin {
	...
	@Test
	public void testValidatePropertiesWithouPublicKey() throws BlowoutException  {
		String username = "Fulano";
		Properties properties = new Properties();		
		properties.put(NAFTokenUpdatePlugin.TOKEN_PLUGIN_USERNAME, username);
		properties.put(NAFTokenUpdatePlugin.NAF_IDENTITY_PUBLIC_KEY, PUBLIC_KEY_PEM);
		...
		try {
			...
			nafTokenUpdatePlugin = new NAFTokenUpdatePlugin(properties);
	...
	@Test
	public void testValidatePropertiesWithouPrivateKey() throws BlowoutException  {
		String username = "Fulano";
		Properties properties = new Properties();		
		properties.put(NAFTokenUpdatePlugin.TOKEN_PLUGIN_USERNAME, username);
		properties.put(NAFTokenUpdatePlugin.NAF_IDENTITY_PUBLIC_KEY, PUBLIC_KEY_PEM);
